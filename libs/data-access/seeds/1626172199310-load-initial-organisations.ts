    ...
    const data = [
      {
        ...
        acronym: 'NOCRI/NIHR',
        units: [
          { name: 'NOCRI/NIHR', acronym: 'NOCRI/NIHR', isShadow: true }
        ]
      },
      {
        ...
        acronym: 'NHS-SC',
        units: [
          { name: 'NHS Supply Chain', acronym: 'NHS-SC', isShadow: true }
        ]
      },
      {
        name: 'NICE',
        acronym: 'NICE',
        units: [
          { name: 'NICE', acronym: 'NICE', isShadow: true }
        ],
      },
      {
        ...
        acronym: 'SHTG',
        units: [
          { name: 'Scottish Heath Technology Group', acronym: 'SHTG', isShadow: true }
        ],
      },
      {
        ...
        acronym: 'NHSE-SC',
        units: [
          { name: 'NHSE Specialised Commissioning', acronym: 'NHSE-SC', isShadow: true }
        ],
      },
      {
        ...
        acronym: 'LSHW',
        units: [
          { name: 'Life Sciences Hub Wales', acronym: 'LSHW', isShadow: true }
        ],
      },
      {
        ...
        acronym: 'DIT',
        units: [
          { name: 'Department for International Trade', acronym: 'DIT', isShadow: true },
        ],
      },
      {
        ...
        acronym: 'HTW',
        units: [
          { name: 'Health Technology Wales', acronym: 'HTW', isShadow: true }
        ]
      },
      {
        name: 'MHRA',
