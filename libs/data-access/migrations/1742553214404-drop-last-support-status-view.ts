...
export class DropLastSupportStatusView1742553214404 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('DROP VIEW last_support_status_view_entity');
  }
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        CREATE VIEW [dbo].[last_support_status_view_entity]
        AS
        SELECT
