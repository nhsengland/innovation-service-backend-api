...
// activity log
export class createViewInnovationProgressWithNewPrototypeOptions1783347097025 implements MigrationInterface {
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    CREATE OR ALTER VIEW [innovation_progress_view] AS
      ...
      IIF(JSON_VALUE(document, '$.UNDERSTANDING_OF_NEEDS.hasProductServiceOrPrototype')
        IN (
          'YES',
          'PROOF_OF_CONCEPT',
          'MVP',
