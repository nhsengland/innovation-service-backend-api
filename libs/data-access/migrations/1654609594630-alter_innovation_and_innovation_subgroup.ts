...
export class alterInnovationAndInnovationSubgroup1654609594630 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(`CREATE UNIQUE INDEX "idx_innovation_patients_citizens_benefit_type_innovation_id" ON "innovation_patients_citizens_benefit" ("type", "innovation_id")`);
    await queryRunner.query(`ALTER TABLE "innovation_patients_citizens_benefit" ADD CONSTRAINT "fk_innovation_patients_citizens_benefit_innovation_innovation_id" FOREIGN KEY ("innovation_id") REFERENCES "innovation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // innovation_patients_citizens_benefit
    await queryRunner.query(`ALTER TABLE "innovation_patients_citizens_benefit" DROP CONSTRAINT "fk_innovation_patients_citizens_benefit_innovation_innovation_id"`);
    await queryRunner.query(`DROP INDEX "idx_innovation_patients_citizens_benefit_type_innovation_id" ON "innovation_general_benefit"`);
