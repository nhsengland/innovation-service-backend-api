...
export class userRolesTableRefactor1674051779936 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_role" ADD CONSTRAINT "idx_user_role_user_id_role_organisation_unit" UNIQUE ("user_id", "role","organisation_id", "organisation_unit_id")`
    );
    await queryRunner.query(
      `ALTER TABLE "user_role" ADD CONSTRAINT "fk_user_role_organisation_id" FOREIGN KEY ("organisation_id") REFERENCES "organisation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;`
    );
    await queryRunner.query(
      `ALTER TABLE "user_role" ADD CONSTRAINT "fk_user_role_organisation_unit_id" FOREIGN KEY ("organisation_unit_id") REFERENCES "organisation_unit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;`
    );
