...
export class alterNotificationUserAddColumnOrgUnit1672931339905 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query(`CREATE INDEX "idx_notification_user_organisation_unit_read" ON "notification_user" ("user_id", "organisation_unit_id", "read_at") WHERE deleted_at IS NULL`);
    }
