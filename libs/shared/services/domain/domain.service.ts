...
import {
  ...
  IdentityProviderServiceSymbol, IdentityProviderServiceType, SQLProviderSymbol, SQLProviderType
} from '../interfaces';
...
export class DomainService {
  ...
  setConnection(connection: DataSource): void {
    this._innovations = new DomainInnovationsService(connection, this.fileStorageService, this.identityProviderService);
    this._users = new DomainUsersService(connection, this.identityProviderService, this._innovations);
  }
