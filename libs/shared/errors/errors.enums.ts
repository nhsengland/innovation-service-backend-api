...
export enum InnovationErrorsEnum {
  ...
  INNOVATION_SUPPORT_UNIT_NOT_STARTED = 'I.0045',
  INNOVATION_SUPPORT_UPDATE_WITH_UNPROCESSABLE_STATUS = 'I.0046',
  INNOVATION_SUPPORT_UPDATE_INACTIVE = 'I.0047',
  ...
  INNOVATION_ASSESSMENT_REASSESSMENT_REQUEST_WITHOUT_PREVIOUS_ASSESSMENT = 'IA.0083',
  INNOVATION_ASSESSMENT_ALREADY_SUBMITTED = 'IA.0084',
  INNOVATION_ASSESSMENT_SUGGESTIONS_CANT_BE_REMOVED = 'IA.0085',
  INNOVATION_ASSESSMENT_SUBMISSION_NO_SUGGESTIONS = 'IA.0086',
  INNOVATION_ASSESSMENT_SUBMISSION_NO_SUMMARY = 'IA.0087',

  INNOVATION_THREAD_NOT_FOUND = 'IT.0001',
  INNOVATION_THREAD_CREATION_FAILED = 'IT.0003',
  INNOVATION_THREAD_WITHOUT_FOLLOWERS = 'IT.0004',
  INNOVATION_THREAD_USER_IS_NOT_FOLLOWER = 'IT.0005',
  INNOVATION_THREAD_INNOVATORS_CANNOT_UNFOLLOW = 'IT.0006',
  INNOVATION_THREAD_CANT_UNFOLLOW_OTHER_USERS = 'IT.0007',
  ...
  INNOVATION_TASK_FROM_DIFFERENT_UNIT = 'IA.0092',
  ...
  INNOVATION_RECORD_INVALID_EXCEL_FILE = 'I.0100',
  ...
  INNOVATION_FILTERS_ALL_INVALID = 'IFL.0001',
  INNOVATION_FILTERS_EMPTY = 'IFL.0002',

  INNOVATION_SUGGESTION_WITHOUT_ORGANISATION_UNITS = 'IS.0001',

  INNOVATION_SURVEY_NOT_FOUND = 'ISU.0001',
...
export enum AnnouncementErrorsEnum {
  ...
  ANNOUNCEMENT_INVALID_UPDATE_STATUS = 'AN.0006',
  ANNOUNCEMENT_CANT_BE_UPDATED_IN_DELETED_STATUS = 'AN.0007'
}
...
export enum ElasticSearchErrorsEnum {
  ...
  ES_REFRESH_ERROR = 'ES.0005',
  ES_COUNT_ERROR = 'ES.0006',
  ES_REINDEX_VALIDATION_ERROR = 'ES.0007'
}

export enum NotificationErrorsEnum {
  NOTIFY_ME_CANNOT_CHANGE_EVENT_TYPE = 'NM.0001',
  NOTIFY_ME_SUBSCRIPTION_NOT_FOUND = 'NM.0002',
  NOTIFY_ME_SUBSCRIPTION_TYPE_NOT_FOUND = 'NM.0003',
  NOTIFY_ME_SCHEDULED_DATE_PAST = 'NM.0004'
}
