...
export class UnauthorizedError extends Error implements BaseErrorType {
  ...
  errorResponse(): AppResponse { return ResponseHelper.Unauthorized({ error: this.name, message: this.message }); }
}
...
export class ForbiddenError extends Error implements BaseErrorType {
  ...
  errorResponse(): AppResponse { return ResponseHelper.Forbidden({ error: this.name, message: this.message, details: this.details }); }
}
...
export class NotFoundError extends Error implements BaseErrorType {
  ...
  errorResponse(): AppResponse { return ResponseHelper.NotFound({ error: this.name, message: this.message, details: this.details }); }
}
...
export class BadRequestError extends Error implements BaseErrorType {
  ...
  errorResponse(): AppResponse { return ResponseHelper.BadRequest({ error: this.name, message: this.message, details: this.details }); }
}
...
export class UnprocessableEntityError extends Error implements BaseErrorType {
  ...
  errorResponse(): AppResponse { return ResponseHelper.UnprocessableEntity({ error: this.name, message: this.message, details: this.details }); }
}
