export const NotificationTypes = {
  ...
  TODO: ['OS03_INNOVATION_DELAYED_SHARED_SUGGESTION', 'AU04_SUPPORT_KPI_REMINDER', 'AU05_SUPPORT_KPI_OVERDUE'] as const,
  NEEDS_ASSESSMENT: [
  ...
  INNOVATION: ['RE01_EXPORT_REQUEST_SUBMITTED'] as const,
