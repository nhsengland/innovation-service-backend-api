...
export type SupportLogParams = {
  description: string;
} & (SupportLogStatusUpdate | SupportLogAccessorSuggestion | SupportLogProgressUpdate | SupportLogAssessmentSuggestion | SupportLogInnovationArchive | SupportLogInnovatorStopSharing);
