...
export const DocumentValidationSchema202209Map: DocumentValidationSchema202209Map = {
  ...
  VALUE_PROPOSITION: Joi.object<DocumentType202209['VALUE_PROPOSITION']>({
    hasProblemTackleKnowledge: Joi.string()
      .valid(...catalogYesNotYetNotSure)
      .optional(),
  ...
  UNDERSTANDING_OF_BENEFITS: Joi.object<DocumentType202209['UNDERSTANDING_OF_BENEFITS']>({
    ...
    patientsCitizensBenefits: Joi.array()
      .items(Joi.string().valid(...catalogPatientsCitizensBenefit))
      .allow(null),
    generalBenefits: Joi.array()
      .items(Joi.string().valid(...catalogGeneralBenefit))
      .min(1)
      .max(3)
      .allow(null),
    otherGeneralBenefit: Joi.string().allow(null),
    environmentalBenefits: Joi.array()
      .items(Joi.string().valid(...catalogEnvironmentalBenefit))
      .min(1)
      .max(3)
      .allow(null),
  ...
  CURRENT_CARE_PATHWAY: Joi.object<DocumentType202209['CURRENT_CARE_PATHWAY']>({
    ...
    innovationPathwayKnowledge: Joi.string()
      .valid(...catalogPathwayKnowledge)
      .allow(null),
  ...
  COMPARATIVE_COST_BENEFIT: Joi.object<DocumentType202209['COMPARATIVE_COST_BENEFIT']>({
    ...
    hasCostCareKnowledge: Joi.string()
      .valid(...catalogHasCostKnowledge)
      .allow(null),
