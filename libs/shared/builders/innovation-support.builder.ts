import { InnovationSupportEntity, InnovationEntity, OrganisationUnitEntity, type OrganisationUnitUserEntity } from '../entities';
...
export class InnovationSupportBuilder {
  ...
  setAccessors(accessors: OrganisationUnitUserEntity[]): InnovationSupportBuilder {
    ...
    this.innovationSupport.status = accessors.length > 0 ? InnovationSupportStatusEnum.ENGAGING: InnovationSupportStatusEnum.WAITING;
    return this;
  }
