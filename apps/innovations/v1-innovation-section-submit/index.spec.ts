...
const mock = jest.spyOn(InnovationSectionsService.prototype, 'submitInnovationSection').mockResolvedValue(expected);

afterEach(() => {
  jest.clearAllMocks();
});

describe('v1-innovation-section-submit Suite', () => {
  describe('200', () => {
