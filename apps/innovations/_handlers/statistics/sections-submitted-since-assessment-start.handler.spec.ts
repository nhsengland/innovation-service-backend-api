import { SectionsSubmittedSinceAssessmentStartStatisticsHandler } from './sections-submitted-since-assessment-start.handler';
...
describe('Sections Submitted Since Assessment Statistics Handler Suite', () => {
  ...
  const mock = jest
    .spyOn(StatisticsService.prototype, 'getSubmittedSectionsSinceAssessmentStart')
    .mockResolvedValue(expected);

  describe('run', () => {
    it('should return the statistic', async () => {
      const handler = new SectionsSubmittedSinceAssessmentStartStatisticsHandler(
