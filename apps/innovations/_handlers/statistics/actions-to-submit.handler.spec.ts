import { ActionsToSubmitStatisticsHandler } from './actions-to-submit.handler';
...
describe('Actions To Submit Statistics Handler Suite', () => {
  ...
  const mock = jest.spyOn(StatisticsService.prototype, 'getActions').mockResolvedValue(expected);
  ...
  describe('run', () => {
    it('should return the statistic', async () => {
      const handler = new ActionsToSubmitStatisticsHandler(
