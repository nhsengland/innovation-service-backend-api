...
const mock = jest.spyOn(InnovationThreadsService.prototype, 'getThreadMessageInfo').mockResolvedValue(expected);

afterEach(() => {
  jest.clearAllMocks();
});

describe('v1-innovation-thread-message-info Suite', () => {
  describe('200', () => {
    it('should return the thread message info', async () => {
