...
class V1InnovationFileUpload {
  ...
  static async httpTrigger(context: CustomContextType, request: HttpRequest): Promise<void> {
    ...
    const innovationFileService = container.get<InnovationFileServiceType>(InnovationFileServiceSymbol);
    ...
    try {
      ...
      const res = await innovationFileService.uploadInnovationFile(requestUser.id, params.innovationId, body.fileName, body.context);
