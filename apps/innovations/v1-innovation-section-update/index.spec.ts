...
const mock = jest.spyOn(InnovationSectionsService.prototype, 'updateInnovationSectionInfo').mockResolvedValue(expected);

afterEach(() => {
  jest.clearAllMocks();
});

describe('v1-innovation-section-update Suite', () => {
  describe('200', () => {
