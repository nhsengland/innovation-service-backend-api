...
const expected = { id: randUuid(), status: InnovationStatusEnum.NEEDS_ASSESSMENT };
const mock = jest.spyOn(InnovationsService.prototype, 'submitInnovation').mockResolvedValue(expected);

afterEach(() => {
  jest.clearAllMocks();
});

describe('v1-innovation-submit Suite', () => {
  describe('200', () => {
    it('should submit the innovation', async () => {
