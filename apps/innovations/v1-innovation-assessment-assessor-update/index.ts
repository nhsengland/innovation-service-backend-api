...
export default openApi(V1InnovationAssessmentAssessorUpdate.httpTrigger as AzureFunction, '/v1/{innovationId}/assessments/{assessmentId}', {
  patch: {
    ...
    requestBody: SwaggerHelper.bodyJ2S(BodySchema, { description: 'The new assessor to be assigned.' }),
    responses: {
      200: {
