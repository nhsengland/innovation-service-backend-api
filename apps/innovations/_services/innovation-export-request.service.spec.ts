...
describe('Innovations / _services / innovation export request suite', () => {
  ...
  describe('getExportRequestInfo', () => {
    ...
    const paulRequest = innovation.exportRequests.requestByPaul;
  ...
  describe('getExportRequestList', () => {
    ...
    it.each([
      [1, DTOsHelper.getUserRequestContext(scenario.users.paulNeedsAssessor, 'assessmentRole')],
      ...
      [4, DTOsHelper.getUserRequestContext(scenario.users.johnInnovator, 'innovatorRole')]
  ...
  describe.skip('updateExportRequest', () => {
    it('should update a request to APPROVED', async () => {});
    it('should update a request to REJECTED', async () => {});
    it('should update a request to CANCELLED', async () => {});
    ...
    it('should return BadRequestError when is a reject without rejectReason', async () => {});
  });
});
