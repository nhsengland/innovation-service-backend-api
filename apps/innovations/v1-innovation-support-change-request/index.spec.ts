...
const expected = randBoolean();
const mock = jest
  .spyOn(InnovationSupportsService.prototype, 'changeInnovationSupportStatusRequest')
...
describe('v1-innovation-support-change-request Suite', () => {
  describe('200', () => {
    it('should return the innovation suggestions', async () => {
      ...
      expect(result.body).toStrictEqual({ success: expected });
