...
const mock = jest.spyOn(InnovationsService.prototype, 'updateInnovationShares').mockResolvedValue();

afterEach(() => {
  jest.clearAllMocks();
});

describe('v1-innovation-shares-update Suite', () => {
  describe('200', () => {
    it('should update the innovation shares', async () => {
      ...
      expect(result.body).toStrictEqual({ id: scenario.users.johnInnovator.innovations.johnInnovation.id });
