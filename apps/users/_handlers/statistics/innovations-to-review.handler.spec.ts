import { innovationsToReviewStatisticsHandler } from './innovations-to-review.handler';
...
describe('Assigned Innovations Statistics Handler Suite', () => {
  ...
  const mock = jest.spyOn(StatisticsService.prototype, 'innovationsToReview').mockResolvedValue(expected);

  it('should return statistics', async () => {
    const res = await innovationsToReviewStatisticsHandler(
