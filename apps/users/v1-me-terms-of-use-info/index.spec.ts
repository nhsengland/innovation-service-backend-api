...
const mock = jest.spyOn(TermsOfUseService.prototype, 'getActiveTermsOfUseInfo').mockResolvedValue(expected);

afterEach(() => {
  jest.clearAllMocks();
});

describe('v1-me-terms-of-use-info Suite', () => {
  describe('200', () => {
    it('should return the terms of use', async () => {
