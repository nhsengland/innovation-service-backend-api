...
const mock = jest.spyOn(TermsOfUseService.prototype, 'createTermsOfUse').mockResolvedValue(expected);

afterEach(() => {
  jest.clearAllMocks();
});

describe('v1-admin-terms-of-use-create Suite', () => {
  describe('200', () => {
    it('should create the terms of use', async () => {
