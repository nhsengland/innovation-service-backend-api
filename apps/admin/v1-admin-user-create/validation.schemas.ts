...
export const BodySchema = Joi.object<BodyType>({
  ...
  organisationAcronym: Joi.string().max(ORGANISATIONS_LENGTH_LIMITS.acronym).optional().description('Acronym of the organisation.'),
  organisationUnitAcronym: Joi.string().max(ORGANISATIONS_LENGTH_LIMITS.unit_acronym).optional().description('Acronym of the organisation unit.'),
  role: Joi.string().valid(...Object.values(AccessorOrganisationRoleEnum)).optional().description('Role of the user within the organisation.')
}).required()
