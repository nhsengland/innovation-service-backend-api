...
> {
  ...
  prepareEmailToInnovationOwner(innovationOwner: RecipientType, innovationName: string, organisationUnitName: string): void {
    this.emails.push({
  ...
  prepareEmailToCollaborators(collaborators: RecipientType[], innovationName: string, organisationUnitName: string): void {
